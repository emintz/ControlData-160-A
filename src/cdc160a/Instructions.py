...
EXC = __double_advance_instruction("EXC", EffectiveAddress.constant, Microinstructions.external_function, 2)
EXF = __single_advance_instruction("EXF", EffectiveAddress.relative_forward, Microinstructions.external_function, 2)
...
INP = VariableTimingInstruction("INP", EffectiveAddress.forward_indirect, Microinstructions.input_to_memory, __double_advance)
IRJ = __no_advance_instruction("IRJ", EffectiveAddress.no_address, Microinstructions.set_ind_rel_bank_from_e_and_jump, 1)
ITA = VariableTimingInstruction("ITA", EffectiveAddress.vacuous, Microinstructions.input_to_a, __single_advance)
